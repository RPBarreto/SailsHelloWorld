...
module.exports.custom = {
  ...
  *                                                                         *
  **************************************************************************/
  sendgridSecret: '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',
  //--------------------------------------------------------------------------
  ...
  fromEmailAddress: 'renan.barretoo@hotmail.com',
  fromName: 'Sails Hello World',

  // Email address for receiving support messages & other correspondences.
  // > If you're using the default privacy policy, this will be referenced
  // > as the contact email of your "data protection officer" for the purpose
  // > of compliance with regulations such as GDPR.
  internalEmailAddress: 'support+development@SailsHello.com',
